...
CREATE TABLE `OrdemServico` (
  ...
  CONSTRAINT `OrdemServico_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `Cliente` (`id`),
  CONSTRAINT `OrdemServico_ibfk_2` FOREIGN KEY (`veiculo_id`) REFERENCES `Veiculo` (`id`)
...
-- Dump completed on 2024-11-04 22:29:19
